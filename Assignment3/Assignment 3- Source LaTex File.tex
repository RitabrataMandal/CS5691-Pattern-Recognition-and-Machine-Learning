...
\begin{enumerate}
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \begin{solutionbox}
        	...
        	\end{bmatrix}
        \end{align*}
        	Hence, $K$ is a valid kernel corresponding of the feature mapping
        	\begin{align*}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \begin{solutionbox}
        	As we can see from Figure \ref{fig:SVD_boundary} the decision boundary which maximize the margin is 
        	\begin{align*}
    ...
    \begin{solutionbox}
    	If we remove the point $(1,1)$ the decision boundary will not change. Because 
    \end{solutionbox} 
    \end{enumerate}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \begin{solutionbox}
        	Written the code and attached below
        \end{solutionbox}
